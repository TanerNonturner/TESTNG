...
public class CommonMethods extends BaseClass {
	...
	/**
	 * 
	 * This method checks if radio or check button is enabled and click element that has the value we want.
	 * 
	 * @param listElement
	 * @param value
	 */
	...
	public static void selectDropdDown(WebElement element ,String textToBeSelected) {
	...
	public static void selectDropdDown(WebElement element, int index) {
		try {
	...
	/**
	 * This method sends text to the alert if there is not alert catchs exception (throws NoAlertPresentexception)
	 * 
	 * @param text
	 */
	 ...
	 * This methods works with new new File("screenshots\\"+filename+".png") it is ok
	 * @param filename
	 */
